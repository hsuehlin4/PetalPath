...
PetalPath 的 GPS 橋接腳本需要 **Python 3.12.0**。

建議使用 [pyenv](https://github.com/pyenv/pyenv) 管理 Python 版本，避免與系統 Python 衝突：
...
# 確認版本
python3 --version  # 應顯示 Python 3.12.0
```

若不使用 pyenv，也可直接從 [python.org](https://www.python.org/downloads/) 下載安裝 Python 3.12.0。

### 2. 安裝 Python 套件

```bash
pip3 install "pymobiledevice3>=7.0.0,<8.0.0"
```
...
> ⚠️ 請勿安裝 pymobiledevice3 8.x 以上版本，目前尚未相容。
